...
| [macOS App](features/macos-app/INDEX.md) | The menu bar app: the Badge dot, Refresh, auto refresh and Update all skills; its Bundled CLI and the Swift client that runs and cancels `skillm --json` |
