...
| [macOS App](features/macos-app/INDEX.md) | The menu bar app: the Badge dot, Refresh, auto refresh, Update all skills and Upgrade and restart; its Bundled CLI and the Swift client that runs and cancels `skillm --json` |
